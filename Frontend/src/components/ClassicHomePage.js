        ...
        >
          <div className="text-center text-white px-4 max-w-4xl mx-auto">
            ...
            <motion.button
              ...
              className="bg-white text-gray-900 px-8 py-4 rounded-none font-semibold text-lg tracking-wider uppercase hover:bg-gray-100 transition-all duration-300 shadow-lg"
            >
              Explore Collection
            </motion.button>
          </div>
