...
// This file will be automatically deployed as /api/cart endpoint
...
async function handleAddToCart(req, res) {
  ...
  console.log(`🛒 SERVERLESS ADD TO CART - User: ${userId}, Product: ${product?.title}`);
  ...
  console.log(`✅ Cart saved via serverless function - ID: ${savedCart._id}`);
...
async function handleGetCart(req, res) {
  ...
  console.log(`📦 SERVERLESS GET CART - User: ${userId}`);
...
async function handleRemoveFromCart(req, res) {
  ...
  console.log(`🗑️ SERVERLESS REMOVE FROM CART - User: ${userId}, Product: ${productId}`);
